    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(blank=True, max_length=11, unique=True, verbose_name='电话')),
                ('email', models.EmailField(blank=True, max_length=64, unique=True, verbose_name='邮箱')),
